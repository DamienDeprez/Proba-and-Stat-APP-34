...
\begin{figure}[!h]
    \centering
  \includegraphics[width = 10cm]{hist3b.png}
...
\begin{figure}[!h]
    \centering
  \includegraphics[width = 10cm]{3e.png}
  \caption{Histograms of the three samples}
\end{figure}

We can see that when n increases the data are more confined around the median, so the estimator becomes better. Moreover, the median is approximately 0 which means that the estimator $\hat{q}_L$ is very closed to exact value of $\hat{q}_s$.
